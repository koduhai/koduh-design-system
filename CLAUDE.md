...
`@koduhai/design-system` is a from-scratch React component library that deliberately has **zero dependency on any third-party component or styling library**. Styling is zero-runtime: design tokens compile to CSS custom properties, component styles are CSS Modules. React 18/19 are peer dependencies; there are no runtime dependencies. WCAG AA is a hard requirement.
